...
Parameters at the beginning of the code can be changed. The following parameters can be safely changed:
	...
	CHORDS_PER_MEASURE (determines how often a chord changes in a measure. Default is 1. 2 should also work.)
	PHRASE_LENGTH (Determines how many measures are in a phrase. Any integer should work.)
	ROOT (Determines the starting octave and key signature. Value is an integer representing MIDI values.)
